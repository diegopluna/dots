	...
	config = function()
		...
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(ev)
				...
				opts.desc =
					"Show LSP implementations", keymap.set("n", "gi", "<cmd>Telescope lsp_implementations<CR>", opts) -- show lsp implementations
		...
		mason_lspconfig.setup_handlers({
			...
			["graphql"] = function()
				...
				lspconfig["graphql"].setup({
					capabilities = capabilities,
					filetypes = { "graphql", "qql", "svelte", "typescriptreact", "javascriptreact" },
				})
			end,
			["emmet_ls"] = function()
